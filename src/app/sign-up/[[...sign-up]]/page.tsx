...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0B0B0D] px-4">
      {/* Background orbs */}
      <div className="orb orb-gold absolute w-[500px] h-[500px] top-[-100px] right-[-100px] animate-slow-drift opacity-40" />
      <div className="orb orb-blue absolute w-[400px] h-[400px] bottom-[-50px] left-[-100px] animate-slow-drift opacity-30" style={{ animationDelay: "-12s" }} />
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-serif text-[28px] text-stone mt-4">Begin the examined life.</h1>
          <p className="text-stone-muted text-sm mt-1">Free to start. No credit card required.</p>
        </div>
        ...
        <div className="glass rounded-2xl p-8 border border-[rgba(255,255,255,0.08)] shadow-[0_24px_80px_rgba(0,0,0,0.6)]">
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="text-stone-muted text-[12px] font-medium block mb-1.5">Full Name</label>
              <input
                type="text"
                value={name}
            ...
            <p className="text-stone-ghost text-[11px] text-center">
